...
for i in range(100):
    ...
    d[0][0].save(f"saved_brains_19/gen_{i}")
    ...
    brains = [b1.cross(b2, new_gene_func = Brain.random_weighted_gene).mutate() for b1 in next_stage_brains for b2 in next_stage_brains if b1 is not b2] + next_stage_brains

sqrt_num = 20

print(f"no | best | best {sqrt_num} | generation")
f = open("logs_17.txt", "w+")
...
for i in range(100):
    ...
    d[0][0].save(f"saved_brains_17/gen_{i}")
    ...
    brains = [b1.cross(b2, new_gene_func = Brain.between_weighted_gene).mutate() for b1 in next_stage_brains for b2 in next_stage_brains if b1 is not b2] + next_stage_brains


sqrt_num = 20

print(f"no | best | best {sqrt_num} | generation")
f = open("logs_14.txt", "w+")
...
for i in range(100):
    ...
    d[0][0].save(f"saved_brains_14/gen_{i}")
